...
#
# Generated by Vivado on Mon Jul 18 13:36:45 -0300 2022
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mips_final.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mips_final.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../mips_final.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
